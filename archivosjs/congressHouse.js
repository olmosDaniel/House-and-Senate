...
//  console.log(dataHouse.results[0].members);


//  var mostrarEstados = []
// for (let i = 0; i < dataHouse.results[0].members.length; i++) {
//   if (mostrarEstados.indexOf(dataHouse.results[0].members[i].state) == -1) {
//     mostrarEstados.push(dataHouse.results[0].members[i].state)
//   }
// }
//  console.table(mostrarEstados.sort())




// function partidosTotales(partido) {
//   let partidos = []
//   for(let i = 0; i < dataHouse.results[0].members[i].length; i++) {
//   if(partidos == dataHouse.results[0].members[i].party){
//     partidos.push(dataHouse.results[0].members[i])
//   }
//   }
//   console.log(partidosTotales)
// }
...
// function estadosTotales(estado) {
//   let estados = []
//   for(let i = 0; i < dataHouse.results[0].members[i].length; i++) {
//   if(estados == dataHouse.results[0].members[i].state){
//     estados.push(dataHouse.results[0].members[i])
//   }
//   }
