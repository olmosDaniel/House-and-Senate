...
//   if (mostrarEstados.indexOf(dataSenate.results[0].members[i].state) == -1) {
//     mostrarEstados.push(dataSenate.results[0].members[i].state)
//   }
// }
...
//   let estados = []
//   for(let i = 0; i < dataSenate.results[0].members[i].length; i++) {
//   if(estados == dataSenate.results[0].members[i].state){
//     estados.push(dataSenate.results[0].members[i])
//   }
//   }
